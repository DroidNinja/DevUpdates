...
import com.dev.hackernews.di.HackerNewsModule
...
@Module(includes = [AndroidWeeklyModule::class, MediumModule::class, RSSModule::class, GithubModule::class, KotlinWeeklyModule::class, HackerNewsModule::class])
